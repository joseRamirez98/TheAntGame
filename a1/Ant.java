...
public class Ant extends Movable implements ISteerable{
	 ...
	 */
	public Ant(float locX, float locY) {
		
		// super(heading, speed, size, locX, locY, color)
		super(0, getRandomInt(2,5), 20, locX, locY, ColorUtil.rgb(255, 0, 0));
	...
	/**
	 * Once Ant location is set through Ant constructor, it should not change.
	...
	public void move() {
		...
		if(deltaX < minWidth || deltaX > maxHeight || deltaY < minWidth || deltaY > maxHeight) {
			return;
		}
